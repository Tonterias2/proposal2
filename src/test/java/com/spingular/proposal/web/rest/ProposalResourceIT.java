...
public class ProposalResourceIT {
    ...
    @Test
    @Transactional
    public void getAllProposalsByProfileIsEqualToSomething() throws Exception {
        // Initialize the database
        ...
        // Get all the proposalList where profile equals to profileId
        defaultProposalShouldBeFound("profileId.equals=" + profileId);

        // Get all the proposalList where profile equals to profileId + 1
        defaultProposalShouldNotBeFound("profileId.equals=" + (profileId + 1));
    }
