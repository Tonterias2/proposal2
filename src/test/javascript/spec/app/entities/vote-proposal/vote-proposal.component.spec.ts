...
import { VoteProposalComponent } from 'app/entities/vote-proposal/vote-proposal.component';
...
describe('Component Tests', () => {
  describe('VoteProposal Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.voteProposals[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
