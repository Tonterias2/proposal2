package com.spingular.proposal.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.spingular.proposal.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.spingular.proposal.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            ...
            createCache(cm, com.spingular.proposal.domain.ProposalUser.class.getName());
            createCache(cm, com.spingular.proposal.domain.ProposalUser.class.getName() + ".proposals");
            createCache(cm, com.spingular.proposal.domain.ProposalUser.class.getName() + ".voteProposals");
