...
/**
 * REST controller for managing {@link com.spingular.proposal.domain.Proposal}.
 */
@RestController
@RequestMapping("/api")
public class ProposalResource {
    ...
    public ResponseEntity<List<ProposalDTO>> getAllProposals(ProposalCriteria criteria, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
