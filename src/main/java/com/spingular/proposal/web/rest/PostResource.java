...
/**
 * REST controller for managing {@link com.spingular.proposal.domain.Post}.
 */
@RestController
@RequestMapping("/api")
public class PostResource {
     ...
     */
    @GetMapping("/posts")
    public ResponseEntity<List<PostDTO>> getAllPosts(PostCriteria criteria, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
